...
export const mapLegalEntitiesFromApi = (legalEntity) => {
    return {
        ...
        signScan: legalEntity.sign_scan ? createBlob(legalEntity.sign_scan) : null, // Создание блоба для скана подписи
        stampScan: legalEntity.stamp_scan ? createBlob(legalEntity.stamp_scan) : null, // Создание блоба для печати
    };
};
