...
const TimeTrackingsTable = observer(() => {
    ...
    const {time:totalTime,cost:totalCost} = timeTrackingStore.getStats() ?? {}
    ...
    const {
        ...
        itemsPerPage,
        handlePageChange,
    } = usePagingData(timeTrackingStore, fetchTimeSpending, () => timeTrackingStore?.getTimeTrackingsArray());
    ...
    const hasAllTimeSpendingsAccess = hasPermission(Permissions.VIEW_ALL_TIME_SPENDINGS);
    ...
    const cols = useMemo(() => [
        {
            ...
            Cell: ({ row }) => {
                ...
                return <div  onClick={() => handleEdit(row.original)}><ManagerCell manager={employee} /></div>
                }
        },
        {
            Header: 'Дата',
