...
import {mapClientDataToBackend, mapClientFromApi} from "../Clients/clients.mapper";
...
const useServiceApi = () => {
  ...
  const updateService = (serviceId,updateData) => {
    ...
    return { setServices,getServiceById,updateService, getServices, getServiceTypes, createService };
};
